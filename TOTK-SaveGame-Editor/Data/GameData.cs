...
namespace TOTK_SaveGame_Editor
{
    ...
    {
        public static IDictionary<uint, string> Modifiers = new Dictionary<uint, string>()
        {
            { 0xB6EEDE09, "None" },
            { 0xA9384C6C, "↑ Attack" },
            { 0xDAD10617, "↑↑ Attack" },
            { 0xD5CAD39B, "↑ Durability" },
            { 0xB2C943EE, "↑↑ Durability" },
            { 0x37EAE30F, "↑ Block" },
            { 0x0B3C94E5, "↑↑ Block" },
            { 0x9659C804, "Throw" },
            { 0xD0EFAC53, "Critical Hit" },
            { 0x7D505BC4, "Quick shot" },
            { 0x54535B3C, "x3 Arrows" },
            { 0x934069CD, "x5 Arrows" }
        };

        public static IDictionary<string, string> Bows = new Dictionary<string, string>()
        {
        ...
        public static IDictionary<string, string> Swords = new Dictionary<string, string>()
        {
        ...
        public static IDictionary<string, string> Shields = new Dictionary<string, string>()
        {
        ...
        public static IDictionary<string, string> Armor = new Dictionary<string, string>()
        {
